...
<!-- This example requires Tailwind CSS v2.0+ -->
    ...
    <div class="flex">
      ...
      <div class="ml-3">
        ...
        <div class="mt-2 text-sm text-yellow-700">
          <p>This is not a real ordering form! This is only an example. This form does not actually work.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="bg-gray-50">
    <div class="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <div v-for="(value, name, index) in errors" class="alert alert-danger">
        <div class="rounded-md bg-red-50 p-1">
          <div class="flex">
            <div class="flex-shrink-0">
              <XCircleIcon class="h-5 w-5 text-red-400" aria-hidden="true" />
            </div>
            <div class="ml-3">
              <h3 class="text-sm font-medium text-red-800">{{ value }}</h3>
            </div>
          </div>
        </div>
      </div>
      <form action="submitorder" class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
        <div>
          <div>
            ...
            <div class="mt-4">
              ...
              <div class="mt-1">
                <input type="email" id="email" name="email" autocomplete="email" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
              </div>
            </div>
          </div>
          ...
          <div class="mt-10 border-t border-gray-200 pt-10">
            ...
            <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
              ...
              <div>
                ...
                <div class="mt-1">
                  <input type="text" name="state" id="state" autocomplete="address-level1" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                </div>
              </div>
          ...
          <div class="mt-4 bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <dl class="border-t border-gray-200 py-6 px-4 space-y-6 sm:px-6">
              <div class="flex items-center justify-between">
                ...
                <dd class="text-sm font-medium text-gray-900">$5.99</dd>
              </div>
              <div class="flex items-center justify-between">
              ...
              <div class="flex items-center justify-between">
                ...
                <dd class="text-sm font-medium text-gray-900">$0.52</dd>
              </div>
              <div class="flex items-center justify-between border-t border-gray-200 pt-6">
                <dt class="text-base font-medium">Total</dt>
                <dd class="text-base font-medium text-gray-900">$11.51</dd>
              </div>
            </dl>

            <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
              <button type="button" class="w-full bg-indigo-600 border border-transparent rounded-md shadow-sm py-3 px-4 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500">Confirm order</button>
            </div>
          </div>
        </div>
      </form>
...
import { CheckCircleIcon, TrashIcon, XCircleIcon, ExclamationIcon } from '@heroicons/vue/solid'
...
const products = [
  {
    ...
    taste: 'spicy',
    size: '4 packs',
    imageSrc: 'img/jinspicy.webp',
    imageAlt: "Korean ramen.",
  },
  // More products...
]
